...
public class NotesController {
    ...
    List<Category> getUserCategories() throws SQLException {
        int userId = LoggedInUser.getId();
    ...
    // Notes
    Note addNote(Note note, int categoryId) throws SQLException {
        int userId = LoggedInUser.getId();
        LOGGER.info("Add note \"{}\" for user with id = {}", note.getName(), userId);
        return service.addNote(note, categoryId, userId);
    }

    void updateNote(Note note, int categoryId) throws SQLException {
        int userId = LoggedInUser.getId();
    ...
    void deleteCategoryNotes(int categoryId) throws SQLException {
        int userId = LoggedInUser.getId();
    ...
    List<Note> getCategoryNotes(int categoryId) throws SQLException {
        int userId = LoggedInUser.getId();
    ...
    List<Note> getUserNotes() throws SQLException {
        int userId = LoggedInUser.getId();
